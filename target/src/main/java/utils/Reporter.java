...
public class Reporter extends OpentapsWrappers{
	...
	public static void reportStep(String desc, String status) {
		...
		if(status.toUpperCase().equals("PASS")){
			test.log(LogStatus.PASS, desc+test.addScreenCapture("reports/images/"+number+".png"));
		}else if(status.toUpperCase().equals("FAIL")){
			test.log(LogStatus.FAIL, desc+test.addScreenCapture("reports/images/"+number+".png"));
	...
	public static void startResult(){
		...
		extent.loadConfig(new File("reports/extent-config.xml"));
	}
